  ...
  return (
    <div className="flex min-h-screen w-full bg-white">
      <aside className="sticky top-0 hidden h-screen w-64 shrink-0 flex-col border-r border-gray-200 bg-gray-50 lg:flex print:hidden">
        ...
        <div className="border-t border-gray-200 px-5 py-4 text-[10px] leading-relaxed text-gray-500">
          {company.endorsement}
          <br />
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <div className="sticky top-0 z-20 flex items-center justify-between border-b border-gray-200 bg-white px-5 py-3 lg:hidden print:hidden">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 border border-gray-200 px-2.5 py-1.5 text-[12px] font-medium text-gray-700">
            
            {open ? <XIcon className="h-4 w-4" strokeWidth={1.5} /> : <MenuIcon className="h-4 w-4" strokeWidth={1.5} />}
            Sections
          </button>
        </div>
