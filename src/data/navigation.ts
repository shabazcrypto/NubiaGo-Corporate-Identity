...
export const navigation: NavItem[] = [
  {
    ...
    description: 'Logo usage, colour, typography, brand book, clearspace and lockups.'
  },
  {
    code: '02',
    label: 'Letterhead',
    ...
    description: 'A4 letterheads, envelopes, with-compliments and footer system.'
  },
  {
    code: '03',
    label: 'Email',
  ...
  },
  {
    ...
    description: '16:9 master template with reusable slide layouts.'
  },
  {
    code: '05',
  ...
  },
  {
    ...
    description: 'A4 cover layouts for profiles, catalogues and proposals.'
  },
  {
    code: '08',
    label: 'Catalogue',
  ...
  },
  {
    ...
    description: 'Covers, profiles, highlights and LinkedIn / feed posts — one digital system.'
  },
  {
    code: '11',
    label: 'Assets',
